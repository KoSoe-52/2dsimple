...
@section('header')
    <div class="col-5 align-self-center">
        <h4 class="page-title text-truncate text-dark font-weight-normal mb-3">Dubai 2D ပေါင်းချုပ်စာရင်း</h4>
    </div>
            ...
            if($(this).is(":checked"))
            {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: baseUrl+'/dubaitwodList/'+id+'/terminate',
                            type: "GET",
                            data: {
                                "_token": "{{ csrf_token() }}",
                            },
            ...
            }else
            {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        //Swal.fire('Saved!', '', 'success')
                        $.ajax({
                            url: baseUrl+'/dubaitwodList/'+id+'/open',
                            type: "GET",
                            data: {
                                "_token": "{{ csrf_token() }}",
                            },
